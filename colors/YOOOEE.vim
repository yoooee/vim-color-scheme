...
call NERDTreeHighlightFile('gitconfig', White, 'none', '#'.hexWhite, '#'.hexDark_Grey)
call NERDTreeHighlightFile('gitignore', White, 'none', '#'.hexWhite, '#'.hexDark_Grey)
...
call NERDTreeHighlightFile('test.js', White, 'none', '#'.hexWhite, '#'.hexDark_Grey)
...
call NERDTreeHighlightFile('DS_Store', Grey, 'none', '#'.hexGrey, '#'.hexDark_Grey)
...
" React
cal <sid>h('xmlTagName', hexPurple, '', Purple, '', '', '')
cal <sid>h('xmlTag', hexPurple, '', Purple, '', '', '')
cal <sid>h('xmlEndTag', hexPurple, '', Purple, '', '', '')
cal <sid>h('xmlAttrib', hexDark_Blue, '', Dark_Blue, '', '', '')
cal <sid>h('xmlString', hexLight_Blue, '', Light_Blue, '', '', '')
